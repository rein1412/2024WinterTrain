...
printf真好用，自己写差点给我脑袋烧了</font>

```c
printf("Line1=%f,Line2=%f\r\n",velocity_aim,real.velocity); 
```
...
<font>在MXcube中配置好串口后，调用串口DMA中断接收函数然后NTR用scanf接收pid</font>
...
![速度闭环](屏幕截图%202024-01-16%20145736.png)
<font>利用pid和速度——电压传递函数完成控制</font>
